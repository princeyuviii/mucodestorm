    ...
    <section className="text-center relative flex flex-col justify-center min-h-screen pt-16">
      ...
      <div className="w-[40rem] h-10 relative">
        ...
        <div className="flex justify-center mt-8">
          <a
            href="https://forms.easebuzz.in/sign-up/Mandsaur0rhTp/Spandan_Hackathon_Tournament_2K25/?inst_name=Mandsaur0rhTp&form_name=Spandan_Hackathon_Tournament_2K25&jsonData=1"
